...
<span style="color: green;font-style: italic;">
"The other thing is there’s a real opportunity for what we typically call 'change management.' If you don’t think through how the technology changes the job, workflow,or collaboration model, then you’re not necessarily directing that additional time toward something that’s more value added." 
-  Lareina Yee
</span>

## Major Players' Use of AI:
...
Amazon is a multinational corporation with several arms including an e-commerce website, a streaming service, and a cloud service. In 2014, Amazon moved towards using deep learning for recommendation engines. This marked the advancement of Amazon towards AI, which is now deeply ingrained in its DNA.
 
Amazon uses artificial intelligence from the moment a customer gets on its website. Talking about the e-commerce shopping arm, Amazon uses consumer data from several sources to customize the landing page of its website for each of the 300 million users that it caters to (V K, 2022). Using this algorithm, it displays those products that customers are most likely to buy.
 
Another area where Amazon used widely available data to cater to customers is the development of its own personal assistant, Alexa. Using algorithms such as voice recognition and natural language processing, it first developed Echo, which is a smart home device that shares information through natural conversation. Developing Alexa was a step forward which helped Amazon use natural conversation throughout its platforms, including streaming and music services.

### Starbucks:

Starbucks is the third largest fast food chain in the entire world and is spread over 30,000 locations (V K, 2022). Starbucks started its AI program as late as 2018 when it started to harvest the data made available through the 90 million customer transactions daily throughout the globe.
 
Using this massive bank of data, Starbucks made better decisions in sales and overall direction of the corporation. A specific use-case was improving their direct marketing technologies such as targeted advertising and personalized drink recommendations. With the data of 13 million customers in its loyalty program, Starbucks began offering customized drinks according to customer preferences (V K, 2022). They also used the widely available data to recommend preferred drinks to customers who have never visited a Starbucks before. Another use-case of AI at Starbucks is the availability of a virtual barista to facilitate the ordering experience.
